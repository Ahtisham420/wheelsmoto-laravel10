<footer>
    <div class="container">
        <div class="row footer1">
            <div class="col-12  col-sm-12 col-md-6 col-lg-4   widget1">
                <div style="margin-top: -18px">
                    <img class="footerlogo" src="{{ config('app.ui_asset_url').'frontend/img/logo/footer-logo.svg' }}">
                </div>
                ...
                <div class="d-inline-block d-md-block">
                    <form class="form-inline" method="post" action="{{route('footer-mail')}}" id="footer-mail">
                        ...
                        <div class="text-center button-loader " style="width: 100%;">
                            ...
                            <button class=" btn btn-block mybtn1  tx-tfm" style=" border-radius: 0px;max-width: 120px; background: #BF0202;color: #fff">Subscribe
            ...
            <div class="col  col-sm-6 col-md-6 col-lg-3 widget3 mt-4">
                <div class="footerheading">Useful Links
                </div>
                <div class="description">
                    <a href="{{url('/contact-us')}}">Contact us</a>
                    <a href="{{url('/about-us')}}">About us</a>
                    <!--<a href="#">Careers Coming Soon</a>-->
                    <a href="https://wheelshunt.com/sitemap.xml" target='_blank'>Sitemap</a>
            ...
            <div class="col-6  col-sm-6 col-md-6 col-lg-3 widget4 mt-4">
...
<div class="container-fluid absolutefooter-wheel">
    <div class="container">
        ...
        <div class="absolutefooter-wheel">
            © Wheels Moto 2020 - 2023 | All rights reserved
        </div>
    </div>
</div>
