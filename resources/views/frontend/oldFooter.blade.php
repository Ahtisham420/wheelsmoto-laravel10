        ...
        <div class="row footer1">
            <div class="col  col-sm-6 col-md-6 col-lg-3   widget1" >
                ...
                <div class="buttongroup socialmediaicongroup">
                    ...
                    <a href="https://www.instagram.com/wheels_hunt/" target="_blank"><i class="	fab fa-instagram"></i></a>
...
{{--                    <a href="https://www.pinterest.co.uk/powerperfor1032/?skipFac=1" target="_blank"><i class="	fab fa-pinterest"></i></a>--}}
            ...
            <div class="col-6  col-sm-6 col-md-6 col-lg-3 widget2">
                ...
                <div class="description">
                    <p>Address:</p>
                    <p>@if(!empty($footer->address)){{$footer->address}}@endif</p>
                    <p>Phone:</p>
                    <p>@if(!empty($footer->phone)){{$footer->phone}}@endif</p>
                    <p>Email: @if(!empty($footer->email)){{$footer->email}}@endif</p>
                </div>
            </div>
            ...
            <div class="col-6  col-sm-6 col-md-6 col-lg-3 widget4">
                ...
                <div class="row">
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/1.jpg' }}">
                    </div>
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/2.jpg' }}">
                    </div>
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/3.jpg' }}">
                    </div>
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/4.jpg' }}">
                    </div>
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/5.jpg' }}">
                    </div>
                    <div class="col-6 col-xs-4 col-sm-4 col-md-4 col-lg-4 footerimgdiv">
                        <img src="{{ config('app.ui_asset_url').'frontend/img/footerimages/6.jpg' }}">
                    </div>
                </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAddbxUhXJYrPqsX24kbEhFR1cJg37U2vA&libraries=places&callback=initProfileAutocomplete&sensor=false" async defer></script>
