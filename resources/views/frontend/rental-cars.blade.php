...
">
    ...
    <div class="row m-0" style="width:100%;">
      ...
      <input type="hidden" id="type-filters" value="Rent">
          ...
          @endif
            ...
            <div class="card">
                <div class="cardimage lease-car-image">
                    <p>{{ $condition_type }}</p>
                    <img class="card-img-top"  src="/../../livepowerperformance/public/crop_images/{{$rental->crop_image}}" alt="Card image cap">
                </div>
                <div class="card-body">
                  <div class=" row ">
                      <div class="col-8 col-sm-12 col-md-8 col-lg-8  americancardbody ">{{$rental->year}}  {{$rental->title}}</div>
                      <div class="col-6 col-sm-12 col-md-6 "><p class="cardPrice">${{$rental->price}}</p></div>
                     <div class="col-6 col-sm-12 col-md-12 col-lg-6 p-0 bidnowbtndiv"><button class="bidnowbtn">Rent Now</button></div>
                  </div>
                  <p class="cardescription">{{$rental->advert_text}}</p>
           </div>
              </div>
