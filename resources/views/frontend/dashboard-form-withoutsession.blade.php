...
GB
            ...
            <input id="registernumber" type="text" class="form-control validate0" name="registration_number" placeholder="LL58 LGK" aria-label="Username" aria-describedby="basic-addon1"
                   value="@if($update)@if($update->registration_no){{$update->registration_no}}@endif @endif">
        </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 mileage">
        ...
        <label>Mileage </label>
        <input id="mileage" type="number" class="form-control validate0" name="milage" placeholder="50,000" min="0" value="@if($update && $update->mileage){{$update->mileage}}@endif">
            ...
            <div class="form-row">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                    <input id="enginesize" type="text" class="form-control validate0" name="engine_size"  placeholder="e.g.2698"
                           value="@if($update)@if($update->engine_size){{$update->engine_size}}@endif @endif">
...
<option value="{{$t->id}}"
    ...
    <div class="form-row">
        <div class="col-md-6 mb-3">
            <div class="form-row">
                ...
                <div class="col-12 col-sm-8 col-md-6 ">
                    <input type="text" id="color" class="form-control validate0" name="color" value="@if($update)@if($update->color){{$update->color}}@endif @endif">
            ...
            <div class="form-row">
                <div class="col-12">
                    @php
                        $brand=App\Brand::all();
                    @endphp
                    <select class="form-control validate0" name="brand"  id="make_manuaf">
                        <option value="">Select Manufacture:</option>

                        @if(!empty($brand)&&count($brand)!=0)
                            @foreach($brand as $t)
                                <option id="{{$t->id}}" value="{{$t->name}}"
                                        @if($update)
                                        @if($update->brand)
                                        @if($update->brand==$t->name)
                                        selected
        ...
        <div class="col-md-9 mb-3">
            <div class="form-row">
                <div class="col-12 colorinput ">
                    <select class="form-control validate0" name="car_type" id="car_type">
    ...
    <div class="form-row">
        ...
        <div class="col-md-9 mb-3">
            <div class="form-row">
                <div class="col-12 ">
                    <input type="text" class="form-control" id="speed" min="1"  max="60" value="@if($update)@if($update->speed){{$update->speed}}@endif @endif" name="speed" placeholder="e.g 0 to 60">
    ...
    <div class="form-row">
        ...
        <div class="col-md-9 mb-3">
            <div class="form-row">
                <div class="col-12 ">
                    <input type="text" class="form-control" id="top_speed" name="top_speed" value="@if($update)@if($update->top_speed){{$update->top_speed}}@endif @endif" placeholder="e.g 100">
            ...
            <div class="form-row">
                ...
                <div class="col-12 col-sm-8 col-md-6">
                    <select class="form-control validate0" name="parking_sensor" >
                        <option value="" disabled>Select Parking Sensor</option>
                ...
                <div class="form-row">
                    <div class="col-12">
                        ...
                        @if(!empty($s))
                            ...
                            @else
                            <input type="text" class="form-control validate1" @if(!empty($update->post_code))value="{{$update->post_code}}"@endif name="post_code"  placeholder="Enter Post Code" required>
                        @endif
                    ...
                    <div class="col-12 checkboxdiv">
                        @if(!empty($tab) && $tab == 'swap')
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="radio custom-control-input" id="customCheck4" name="availibilty[]" value="Swap" checked>
    ...
    <div class="col-12 formdiv">
        ...
        <div class="form-row">
            ...
            <div class="col-md-9 mb-3">
                <div class="form-row">
                    <div class="col-12 audimodel">
                        <p><input type="file" name="video" id="video-upload" class="validate2"   style="display: none;" accept="video/*" ></p>
                        ...
                        <p class="imageborder" id="videos_err" style="display: none">
                            ...
                            @if($update && $update->video_url)


                                              <video id="video1" controls height="300" width="100%" src='../../../storage/app/public/{{$update->video_url}}'/>
