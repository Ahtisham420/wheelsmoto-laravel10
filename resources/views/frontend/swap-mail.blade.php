    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 email-body-internal">
                <h6>Hello {{$car_u->username}},</h6>
                <p><span>Congratulations! </span> this car brand {{$car_detail->brand}}<img  src="{{ config('app.ui_asset_url').'frontend/img/logo/logo.png' }}" alt="">. you want to swap your car .</p>
            <a href="" class="btn btn-danger">Decline</a>
                <a href="{{route('swap-status',['id'=>base64_encode($car_detail->id)])}}" class="btn btn-primary">Accept</a>
                <p>Best Regards:</p>
