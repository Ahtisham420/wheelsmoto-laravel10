    ...
    <div class="container">
        <div class="row" style="margin: 44px 0;">
            <div class="col-12  col-sm-4  col-md-4 col-lg-12 search-result-heading">
                <div class="pageheading" style="text-align: center;">All Vehicle Types</div>
            </div>
            ...
            <div class="row d-flex align-items-center justify-content-center" >
                ...
                @if(!empty($type) && count($type) > 0)
                    @foreach($type as $brand)
                        <div class="col-6 col-lg-2 col-sm-4 col-md-3 car-brand">
                            <a href="{{route('index-car-type',['type'=> strtr($brand->_value,' ','-')])}}">
                                @if(!empty($brand->icon))
                                    <img  src="/../../public/car_icon/{{$brand->icon}}">
                                @else
                                    <img  src="{{ config('app.ui_asset_url').'frontend/img/sliderSection/wheelshunticon/slidericon/car.png' }}">
                                @endif
                                <p class="text-center">{{$brand->_value}}</p>
                            </a>
                        </div>
                    @endforeach
                @endif
