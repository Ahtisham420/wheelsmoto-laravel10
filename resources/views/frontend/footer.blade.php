    ...
    <div class="footer-inner">
        <div class="frame-group">
            <div class="support-parent">
                ...
                <div class="home">Help Centre</div>
                <div class="home">AirCover</div>
                <div class="home">Combating discrimination</div>
                <div class="home">Supporting people with disabilities</div>
                <div class="home">Cencellation options</div>
                <div class="home">Report neighbourhood concern</div>
            </div>
            <div class="support-parent">
                <div class="support">Hosting</div>
                <div class="home">Local home</div>
                <div class="home">Cover for hosts</div>
                <div class="home">Hosting resources</div>
                <div class="home">Community forum</div>
                <div class="home">Hosting responsibly</div>
            </div>
            <div class="support-parent">
                <div class="support">Localhost</div>
                <div class="home">Newsroom</div>
                <div class="home">New Features</div>
                <div class="home">Careers</div>
                <div class="home">Investres</div>
                <div class="home">Gift cards</div>
            </div>
        </div>
    </div>
</div>
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAddbxUhXJYrPqsX24kbEhFR1cJg37U2vA&libraries=places&callback=initAutocomplete"
    async defer></script>
...
//$("#bhp").val(data.result['GetVehicleDataResult']['VehicleRegistration']['EngineCapacity']);
                        ...
                        $('#registration_invalid_message').css({
                            color: "red",
                            display: "block",
                            bottom: "-11px",
                            fontSize: "15px"
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        ...
                        // $("#garage_status").css({backgroundColor:"#d4edda",textAlign:"center",display:"block"});
                        // $("#garage_status").html(data.msg);
                        window.location = "{{route("user-dashboard",["tab"=>"mymiscellaneous"])}}";
    ...
    $('.owl-carousel').owlCarousel({
        ...
        autoplay: true,
        nav: true,
        navText: ['<i class="fa fa-angle-right r" aria-hidden="true" style="font-size:20px;Colour:green"></i>', '<i class="fa fa-angle-left l" aria-hidden="true" style="font-size:20px"></i>'],
        responsive: {
            0: {
                items: 3,
                navText: false
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAddbxUhXJYrPqsX24kbEhFR1cJg37U2vA&libraries=places&callback=initProfileAutocomplete&sensor=false"
    async defer></script>
