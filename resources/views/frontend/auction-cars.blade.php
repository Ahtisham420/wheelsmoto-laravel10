...
">
        ...
        @include('frontend.filters')
              ...
              <input type="hidden" id="type-filters" value="auction">
              <div class="col-12 col-sm-12 col-md-12 col-lg-9 p-0 ">
                <div class="col-12  col-sm-4  col-md-4 col-lg-6 search-result-heading"><div class="pageheading ">Search Results for Auction</div></div>
