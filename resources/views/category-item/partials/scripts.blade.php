<script>
    ...
    $(document).on('click','.js-filter-export' ,function() {
        ...
        window.open(baseurl + '/news_letter'+_string, '_blank');
    });
    $(document).on('click','.js-filter-apply' ,function() {
            let baseurl = $('meta[name=baseurl]').attr("content");
            var _string = filters();
            console.log(_string)
            axios.get(baseurl + '/news_letter'+_string)
    ...
    $(document).on('click','.js-filter-reset' ,function() {
        let baseurl = $('meta[name=baseurl]').attr("content");
        window.location.assign(baseurl + '/news_letter');
    });
    $(document).on('click','.js-restriction-reason-submit' ,function() {
        ...
        axios.post(baseurl + '/users/restrict', formData, {})
            .then(function(response) {
                console.log(response)
