                ...
                <div class="card">
                    <form method="post" action="{{route('save-category')}}" enctype="multipart/form-data">
                        ...
                        <div class="card-header">
                            <strong>{{ __('admin/layout.add') }}</strong>
                            {{--<small>Form</small>--}}
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    @include('category.partials.classification-select',$classifications)
                                                    @include('category.partials.sub-classification-select',$sub_classifications)
                                                    @include('category.partials.category-select',$categories)
                                                    @include('category.partials.nature-select')
                                                      <div class="form-group">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <img id="preview_icon_img" style="width:30%;" src="{{ config('app.coure_ui_asset_url').'images/defaults/square-placeholder.jpg' }}"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <img id="preview_interest_img" style="width:50%;" src="{{ config('app.coure_ui_asset_url').'images/defaults/portrait.jpg' }}"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <img id="preview_feature_img" style="width:100%;" src="{{ config('app.coure_ui_asset_url').'images/defaults/350x150.png' }}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row" style="width: 200%;">
                                                        <div class="col-6 mt-4 ml-5" id="attr_ap">
                                                            <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a class="btn btn-sm btn-danger" type="reset" href="{{route('all-categories')}}">
